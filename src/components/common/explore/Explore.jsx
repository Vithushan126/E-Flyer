            ...
            >
              {isMiddle && (
                <div className="absolute inset-0 flex flex-col justify-between p-4 sm:p-6 text-white">
                  ...
                  <p className="absolute top-[70px] sm:top-[87px] md:top-[100px] left-4 sm:left-8 w-[90%] sm:w-[80%] md:w-[400px] lg:w-[450px] text-justify text-xs xs:text-sm sm:text-base md:text-lg leading-relaxed">
