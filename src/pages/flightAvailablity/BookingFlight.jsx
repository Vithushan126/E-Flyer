  ...
  return (
    <div className="flex flex-col space-y-10 w-full">
      <div className="overflow-x-scroll scrollbar-hide">
        <div className="rounded-lg md:rounded-3xl border border-darkBlue text-smokyGray p-2 md:p-4 lg:p-8 w-fit md:w-full">
          <Formik
                    ...
                    >
                      <label className="flex items-center justify-between cursor-pointer w-full">
                        <div className="flex flex-row justify-between items-center w-full">
                          ...
                          <div className="flex flex-col items-center">
                            <span className="">{flightItem.arrival_date}</span>
                            <span className="font-medium">
...
//                     <div className="w-[70px] h-[70px] border border-border rounded-full p-2 flex items-center justify-center">
//                       <img
//                         src={QatarAirwaysLogo}
//                         alt="QatarAirwaysLogo"
//                         className="w-full h-full object-contain"
//                       />
//                     </div>
//                   </div>
