...
//         {/* Tab Navigation */}
//         <div className="border border-smokeGray rounded-2xl p-2 lg:p-4">
//           <div className="flex flex-row justify-between text-gray overflow-x-auto scrollbar-hide">
//             {tabs.map((tab) => (
//               <button
//                 key={tab.id}
//                 onClick={() => setActiveTab(tab.id)}
//                 className={`py-3 px-8 rounded-3xl w-fit font-medium flex items-center text-nowrap cursor-pointer text-smokyGray hover:text-darkBlue ${
