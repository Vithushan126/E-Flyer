...
import SeaniorImage from "../../../assets/adventure/Seanior.svg";
  ...
  return (
    <>
      <div className="space-y-20 mx-2">
        <AdventureIntro
          image={SeaniorImage}
          title="Seniors Adventures"
          paragraph={paragraph}
        />
        <TrendingAdventures title="Trending Seniors Adventures" />
        <CardAndCity title="Seniors Packages" />
        <AdventureWorld title="Seniors tour around the world" />
        <Expect title="What to Expect on a Seniors vacation " data={data} />
        <Feedback title="Feedback and Review About Seniors Adventure" />
      </div>
    </>
  );
};
