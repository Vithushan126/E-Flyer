            ...
            <div className="flex flex-row justify-start items-center mb-8 space-x-8 m-8">
                {["Return", "One Way", "Multi City"].map((type) => (
                    <label key={type} className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-smokeGray lg:text-base text-xs">{type}</span>
                    </label>
                ))}
            </div>
                    ...
                    <div className="flex flex-row items-center p-[10px_20px] gap-[20px] sm:w-[250px] h-[57px] bg-backgroundColor rounded-[20px] md:w-full">
                        ...
                        <div className="flex flex-col items-start gap-[3px]">
                            ...
                            <Field
                                ...
                                onChange={(e) => setFieldValue("departure1", e.target.value)}
                            />
                            {errors.departure1 && touched.departure1 && (
                                <span className="text-red-500 text-xs">{errors.departure1}</span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex flex-row items-center p-[10px_20px] gap-[20px] sm:w-[250px] h-[57px] bg-backgroundColor rounded-[20px] md:w-full">
                        ...
                        <div className="flex flex-col items-start gap-[3px]">
                            ...
                            <Field
                                ...
                                onChange={(e) => setFieldValue("destination1", e.target.value)}
                            />
                            {errors.destination1 && touched.destination1 && (
                                <span className="text-red-500 text-xs">{errors.destination1}</span>
                            )}
                        </div>
                    </div>
