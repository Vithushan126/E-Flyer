...
const validationSchema = Yup.object().shape({
  ...
  adults: Yup.number().min(1).max(9).required("Adult passengers required"),
  children: Yup.number().min(0).max(9).required("Child passengers required"),
  babies: Yup.number().min(0).max(9).required("Baby passengers required"),
